...
**Описание:** 
специфичная уязвимость Nginx. Возникает, если в конфигурации директива `location` не заканчивается слэшем, а директива `alias` заканчивается. Позволяет читать смежные директории.
